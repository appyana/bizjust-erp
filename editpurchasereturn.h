#ifndef EDITPURCHASERETURN_H
#define EDITPURCHASERETURN_H
...
namespace Ui {
class EditPurchaseReturn;
}

class EditPurchaseReturn : public QWidget
{
    Q_OBJECT
...
public:
    ...
    ERP erp;
    SCH sch;
    explicit EditPurchaseReturn(QWidget *parent = 0);
    ~EditPurchaseReturn();
