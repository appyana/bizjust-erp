#ifndef ADDSALESRETURN_H
#define ADDSALESRETURN_H
...
namespace Ui {
class AddSalesReturn;
}

class AddSalesReturn : public QWidget
{
    Q_OBJECT
...
public:
    ...
    ERP erp;
    SCH sch;
    explicit AddSalesReturn(QWidget *parent = 0);
    ~AddSalesReturn();
