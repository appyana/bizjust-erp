...
#include "ui_addcashreceipt.h"

AddCashReceipt::AddCashReceipt(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::AddCashReceipt)
{
    ui->setupUi(this);
    loadform();
}
...
void AddCashReceipt::autocompleter(QString sql, QLineEdit *name_txt, QLineEdit *id_txt)
{
...
void AddCashReceipt::onItemHighlighted(const QModelIndex &index)
{
...
void AddCashReceipt::editingFinished()
{
...
void AddCashReceipt::on_accountname_textEdited(const QString &arg1)
{
   QString sql = sch.glaccount_generalize(arg1);
   autocompleter(sql,ui->accountname, ui->accountid);
}

void AddCashReceipt::loadform()
{
...
void AddCashReceipt::on_btn_add_clicked()
{
...
void AddCashReceipt::checktotal()
{
    float tot_amt=0;
...
void AddCashReceipt::on_btn_delete_row_clicked()
{
...
void AddCashReceipt::on_btn_save_clicked()
{
